...
### 🌍 **Contact me:**
<p align="left">
  <a href="https://www.lauramadrid.ca/" target="_blank">
    <img src="https://raw.githubusercontent.com/iconic/open-iconic/master/svg/globe.svg" alt="website" height="22" width="22"/>
    <span style="background-color: #4CAF50; color: white; padding: 10px 20px; margin: 10px; border-radius: 5px; text-decoration: none;">Website</span>
  </a>
  <a href="https://www.linkedin.com/in/laura-madrid/" target="_blank">
    <img src="https://cdn.jsdelivr.net/npm/simple-icons@v3/icons/linkedin.svg" alt="linkedin" height="22" width="22"/>
    <span style="background-color: #0077B5; color: white; padding: 10px 20px; margin: 10px; border-radius: 5px; text-decoration: none;">LinkedIn</span>
  </a>
  <a href="mailto:madrid.laura@outlook.com">
    <img src="https://simpleicons.org/icons/minutemailer.svg" alt="email" height="22" width="22"/>
    <span style="background-color: #D14836; color: white; padding: 10px 20px; margin: 10px; border-radius: 5px; text-decoration: none;">Email</span>
  </a>
</p>
